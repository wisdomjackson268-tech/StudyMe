<?php
/**
 * StudyMe AI Platform - Unified Dashboard Header Layout
 */
...
// Avoid running subscription DB queries for students to prevent blocking dashboard load.
$subscription = null;
    ...
    <div class="dashboard-main">
        ...
        <header class="dashboard-topbar">
            <div class="d-flex align-items-center gap-3">
                <button class="btn btn-outline-secondary d-lg-none rounded-circle p-2" type="button" id="mobileSidebarToggle" aria-label="Toggle Sidebar">
                ...
                <div class="dropdown">
                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 text-decoration-none text-main dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="d-none d-sm-block text-start">
                            <div class="fw-bold small line-clamp-1"><?= e($user['first_name'] ?? 'User') ?> <?= e($user['last_name'] ?? '') ?></div>
                            <div class="text-muted" style="font-size: 0.75rem; text-transform: capitalize;"><?= e($role ?? 'Student') ?></div>
                        </div>
                    </a>
