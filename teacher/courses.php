<?php
/**
 * StudyMe AI Platform — Teacher Course Manager
 */
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?= url('teacher/create-course.php') ?>" class="btn btn-primary rounded-pill px-4 fw-bold" data-feedback="click">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                    <div class="position-relative">
                        <?php $tThumb = function_exists('get_course_thumbnail_url') ? get_course_thumbnail_url($c['thumbnail'] ?? '', 'technology') : ($c['thumbnail'] ?? 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=500&q=80'); ?>
                        <img src="<?= e($tThumb) ?>"
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-1 me-auto mb-2 small">
                            <?= e($c['category_name'] ?: 'General') ?>
                        </span>
                        <h5 class="fw-bold mb-2"><?= e($c['title']) ?></h5>
...
<?php else: ?>
    <div class="card border-0 shadow-sm rounded-4 p-5 text-center my-4">
        <i class="bi bi-journal-plus text-muted display-3 mb-3"></i>
        <h4 class="fw-bold">No Courses Found</h4>
        <p class="text-muted max-w-md mx-auto mb-4">You haven't created any courses yet. Start building your first course to begin teaching.</p>
        <a href="<?= url('teacher/create-course.php') ?>" class="btn btn-primary rounded-pill px-4 py-2 fw-bold align-self-center">Create Your First Course</a>
    </div>
<?php endif; ?>
