<?php
/**
 * StudyMe AI Platform — Teacher Account Settings & Security Page
 */
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
    <div>
        <h1 class="h3 fw-bold mb-1"><i class="bi bi-gear-fill text-primary me-2"></i> Instructor Account Settings</h1>
        <p class="text-muted mb-0">Manage your password security, appearance preferences, and notification settings.</p>
    </div>
</div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 mb-4 bg-white">
            ...
            <form action="<?= url('teacher/settings.php') ?>" method="POST">
                ...
                <button type="submit" class="btn btn-warning rounded-pill px-4 fw-bold text-dark" data-feedback="click">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 mb-4 bg-white">
            ...
            <div class="d-flex align-items-center justify-content-between py-3">
                <div>
                    <h6 class="fw-bold mb-1">Interactive Sound Effects</h6>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
            <h5 class="fw-bold mb-3">Looking for profile details?</h5>
            <p class="text-muted small mb-3">Update your instructor bio, qualifications, subject specialization, and avatar on your profile page.</p>
            <a href="<?= url('teacher/profile.php') ?>" class="btn btn-outline-primary rounded-pill px-4 fw-bold d-inline-flex align-items-center gap-2">
                <i class="bi bi-person-badge"></i> Edit Instructor Profile &rarr;
            </a>
        </div>
    </div>
</div>
